...
class PersonTest {
    ...
    @CsvSource(useHeadersInDisplayName = true, textBlock = """
         ...
         Queen,         Elizabeth II,       1926-04-21,     96
         King,          Charles III,        1948-11-14,     74
         Prince,        William of Wales,    1982-06-21,     40
         Prince,        George of Wales,    2013-07-22,     9
         Uncle,         Bob,                1952-12-05,     70
        """)
    ...
    @CsvSource(useHeadersInDisplayName = true, textBlock = """
         ...
         King,          Charles III,        1948-11-14,     2023-01-22, 74
         Uncle,         Bob,                1952-12-05,     2023-01-22, 70
        """)
